...
class BNodeCompareOperation(_base.BStaticEnum):
	...
	BRIGHTER = dict(n='Brighter', d='True when the first input is brighter')
	DARKER = dict(n='Darker', d='True when the first input is darker')
